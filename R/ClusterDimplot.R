#' @export
ClusterDimplot <- function(seurat_object, group.by = 'seurat_clusters', clusters, cluster_col = 'seurat_clusters', pt.size = 0.2, xlim = c(-15,15), ylim = c(-15,15), nrow = 1, shuffle = TRUE, seed = 123){
